...
![Most Popular Topics by Frequency.](png('graph/topicfreq.png'))

![Most Tweeted & Favorited Topic - Blue Moon](png('graph/bluemoon.png'))

![Most Tweeted & Favorited Topic - Guiness](png('graph/Guiness.png'))

![Most Tweeted & Favorited Topic - TsingTao](png('graph/tsingtao.png'))

![Most Tweeted & Favorited Topic - Bud Light](png('graph/budlight.png'))

![Most Tweeted & Favorited Topic - Dos Equis](png('graph/DosEquis.png'))
...
![Top 5 Tweeted topics on Saturdays by Blue Moon Beer Co.](png('graph/Blue Moon Beer Top 5 Topics on Sat Final.png'))

![Top 5 Tweeted topics on Saturdays by Dos Equis Beer Co.](png('graph/Dos Equis Top 5 Topics on Sat Final.png'))

![Top 5 Tweeted topics on Saturdays by Budlight Beer Co.](png('graph/Budlight Top 5 Topics on Sat Final.png'))

![Top 5 Tweeted topics on Saturdays by Tsingtao Beer Co.](png('graph/Tsingtao Top 5 Topics on Sat Final.png'))

![Top 5 Tweeted topics on Saturdays by Guinness US Beer Co.](png('graph/Guinness US Top 5 Topics on Sat Final.png'))
...
![Most Frequently tweeted words by Blue Moon Beer Co.](png('graph/BlueMoonBeerCoCloud.png'))

![Most Frequently tweeted words by Dos Equis Beer Co.](png('graph/DosEquisCloud.png'))

![Most Frequently tweeted words by Budlight Beer Co.](png('graph/budlightCloud.png'))

![Most Frequently tweeted words by Tsingtao Beer Co.](png('graph/tsingtaoCloud.png'))

![Most Frequently tweeted words by Guinness US Beer Co..](png('graph/GuinnessUSCloud.png'))

![Most Frequently tweeted words by All 5 Beer Companies](png('graph/AllBeerCloudl.png'))
